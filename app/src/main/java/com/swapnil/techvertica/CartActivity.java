...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView= (RecyclerView) findViewById(R.id.load_cart);
    ...
    class GetCart extends AsyncTask<Void,Void,Void>
    {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            mAdapter = new SelectedAdapter(CartActivity.this,allProduct);
    ...
    public void setData()
    {
        String item=sharedpreferences.getString("cart","");
